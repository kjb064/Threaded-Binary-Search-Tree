pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~lab5.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~lab5.adb");
...
package body ada_main is
   ...
   E82 : Short_Integer; pragma Import (Ada, E82, "binarysearchtree_E");
...
--  BEGIN Object file/option list
   ...
   --   ./lab5.o
   --   -L./
   --   -LC:UsersKevinDesktopCOSC(H~1DATAST~1labsLAB5~1src/
   --   -L/usr/lib/gcc/x86_64-pc-cygwin/6.4.0/adalib/
   --   -static
   --   -lgnat
   --   -Wl,--stack=0x2000000
